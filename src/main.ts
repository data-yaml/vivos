import { Duration, App, Stack, type StackProps } from 'aws-cdk-lib';
import {
  AccountPrincipal,
  ManagedPolicy,
  PolicyStatement,
...
export class VivosStack extends Stack {
  ...
  public static defaultProps(context: any = {}): VivosStackProps {
    ...
    return cc.defaultProps() as VivosStackProps;
  }
...
new VivosStack(app, 'vivos-dev', VivosStack.defaultProps());
